...
namespace MITJobTracker.Migrations
{
    ...
    [Migration("20260420222713_DropProspectListDTOTable")]
    partial class DropProspectListDTOTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MITJobTracker.Data.DailyJobSearchLog", b =>
                {
                    ...
                    b.Property<string>("ExternalJobId")
                        ...
                        .HasComment("External job ID returned by the search API");

                    b.Property<bool>("IsReviewed")
                        .HasColumnType("bit")
                        .HasComment("True when the user has marked this job as reviewed");

                    b.Property<DateTime>("RetrievedAtUtc")
                        .HasColumnType("datetime2")
                        .HasComment("UTC timestamp when the record was first created");

                    b.Property<DateTime?>("ReviewedAtUtc")
                        .HasColumnType("datetime2")
                        .HasComment("UTC timestamp when the job was marked reviewed (null if not reviewed)");

                    b.Property<DateTime>("SearchDate")
                        .HasColumnType("datetime2")
                        .HasComment("Calendar date (UTC) on which the job was retrieved");
