...
{
    /// <inheritdoc />
    public partial class usp_ViweProspect : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                ...
                --         Replaced FREETEXT with LIKE operator due to missing full-text index.
                -- ===========================================================================
                SET NOCOUNT ON;

                -- Modify the default search value: the quotes needed for FREETEXT are not needed for LIKE
